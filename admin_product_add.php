...
<body class="luxury-light-theme bg-white d-flex flex-column min-vh-100">
    ...
    <nav class="navbar navbar-expand-lg sticky-top p-3 boreal-navbar bg-white border-bottom border-light">
        <div class="container-fluid px-lg-5">
            <a class="navbar-brand text-uppercase fw-bold fs-3 tracking-wide text-dark boreal-brand" href="admin_products.php">
                ...
                <div class="col-lg-10">
                    <div class="card bg-white border border-light rounded-0 shadow-sm p-4 p-md-5">
                        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom border-light pb-3">
                             <h2 class="text-dark font-playfair mb-1"><?php echo $is_edit ? 'Edit Product' : 'Add New Product'; ?></h2>
                        </div>
                        ...
                        <form id="product-form">
                            ...
                            <div class="row g-4 text-start">
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        <label class="form-label text-dark text-uppercase tracking-wider fs-8 fw-bold">Product Name</label>
                                        <input type="text" class="form-control border-light rounded-0 shadow-none ps-2" name="name" required value="<?php echo htmlspecialchars($product['name']); ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-dark text-uppercase tracking-wider fs-8 fw-bold">Description</label>
                                        <textarea class="form-control border-light rounded-0 shadow-none ps-2" name="description" rows="5"><?php echo htmlspecialchars($product['description']); ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                         <label class="form-label text-dark text-uppercase tracking-wider fs-8 fw-bold">Base Image URL</label>
                                         <input type="text" class="form-control border-light rounded-0 shadow-none ps-2" name="image_url" value="<?php echo htmlspecialchars($product['image_url']); ?>" placeholder="images/image.png">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                     <div class="card bg-light border-0 rounded-0 p-4">
                                        <div class="mb-3">
                                            <label class="form-label text-dark text-uppercase tracking-wider fs-8 fw-bold">Price ($)</label>
                                            <input type="number" step="0.01" class="form-control border-light rounded-0 shadow-none ps-2 font-mono" name="price" required value="<?php echo $product['price']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label text-dark text-uppercase tracking-wider fs-8 fw-bold">Total Stock</label>
                                            <input type="number" class="form-control border-light rounded-0 shadow-none ps-2 font-mono" name="stock" required value="<?php echo $product['stock']; ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label text-dark text-uppercase tracking-wider fs-8 fw-bold">Category</label>
                                            <select class="form-select border-light rounded-0 shadow-none" name="category">
                                                <?php 
                            ...
                            <div class="mt-5 pt-4 border-top border-light">
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <button type="button" class="btn btn-outline-dark btn-sm rounded-0 text-uppercase fs-9 tracking-wider" id="add-variant-btn">
                                ...
                                <div id="variants-container">
                                    <?php if(empty($variants)): ?>
                                        <div class="variant-item-placeholder text-center py-4 bg-light border border-dashed text-secondary fs-8 mb-3">
                                    ...
                                    <div class="variant-row card bg-light border-0 rounded-0 p-3 mb-3 position-relative">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="variants[<?php echo $index; ?>][color_name]" class="form-control form-control-sm border-light rounded-0" placeholder="e.g. Midnight Blue" value="<?php echo htmlspecialchars($v['color_name']); ?>" required>
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <button type="submit" class="btn btn-dark rounded-0 w-100 py-3 text-uppercase fs-7 fw-bold tracking-wider mt-5" id="save-btn">
